                ...
                <div class="box box-primary">
                    ...
                    <div class="box-footer">
                        <div class="user-block">
                            <img class="img-circle img-bordered-sm" src="${path}/dist/img/default-user.png"
                                 alt="user image">
                            <span class="username">
                        ...
                        <c:if test="${not empty login}">
                            <form>
                                ...
                                <div class="col-sm-2" hidden>
                                    <input class="form-control" id="newReplyWriter" type="text" value="${login.userId}"
                                           readonly>
                                </div>
...
<script>
    $(document).ready(function () {
        ...
        $(".replyAddBtn").on("click", function () {
            ...
            $.ajax({
                type: "POST",
                url: "http://127.0.0.1:5000/add_comment", // Replace with your Python service URL
